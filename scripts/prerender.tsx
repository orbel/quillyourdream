...
import { artworks } from "../shared/schema.js";
...
async function generateStaticRoutes(): Promise<Route[]> {
  const routes: Route[] = [
    {
      path: "/",
    ...
    },
    {
      ...
      description: "Learn about Shushan Aleksanyan, a Los Angeles-based paper quilling artist creating stunning handcrafted artwork and custom commissions."
    },
    {
      path: "/faq",
...
async function generateHtmlTemplate(route: Route, assetManifest: any): Promise<string> {
...
async function prebuildStatic() {
  ...
  for (const route of routes) {
    const html = await generateHtmlTemplate(route, assetManifest);
